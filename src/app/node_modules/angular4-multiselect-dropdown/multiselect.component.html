    ...
    <div class="selected-list" #selectedList>
		...
		s1.535-0.293,2.121-0.879c1.172-1.171,1.172-3.071,0-4.242L28.228,23.986z" />
            ...
            <span class="countplaceholder"
                *ngIf="selectedItems?.length > settings.badgeShowLimit">+{{selectedItems?.length -
...
--><span *ngIf="!isActive" class="c-angle-down">
    ...
    <div [setPosition]="selectedListHeight?.val" class="dropdown-list"
        [ngClass]="{'dropdown-list-top': settings.position == 'top'}" [hidden]="!isActive">
        ...
        <div class="list-area">
            ...
            <div class="list-filter" *ngIf="settings.enableSearchFilter">
                <span class="c-search">
                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100%" height="100%"
                        viewBox="0 0 615.52 615.52" style="enable-background:new 0 0 615.52 615.52;"
                        xml:space="preserve">
                        <g>
                            <g>
                ...
                <input class="c-input" *ngIf="settings.lazyLoading && !searchTempl" #searchInput type="text"
                    [placeholder]="settings.searchPlaceholderText" (keyup)="filterInfiniteList($event)">
            ...
            <div *ngIf="settings.groupBy" [style.maxHeight]="settings.maxHeight+'px'" style="overflow: auto;">
                <ul *ngFor="let obj of groupedData ; let i = index;" class="list-grp">
                    ...
                    <span *ngIf="itemTempl">
                        <li *ngFor="let item of obj.value | listFilter:filter : settings.searchBy; let i = index;"
                            (click)="onItemClick(item,i,$event)" class="pure-checkbox">
                            <input *ngIf="settings.showCheckbox" type="checkbox" [checked]="isSelected(item)"
                                [disabled]="settings.limitSelection == selectedItems?.length && !isSelected(item)" />
                            <label></label>

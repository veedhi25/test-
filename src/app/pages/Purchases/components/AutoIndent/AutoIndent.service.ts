...
export class AutoIndentService {
  ...
  public saveIndent(Indent, IndentList: any[], IndentReceivedFromOutlet: any[]) {
    let res = { status: "error", result: "" };
    let returnSubject: Subject<any> = new Subject();
    ...
    let bodyData = { data: Indent, dataList: IndentList.filter(x => x.MCODE != null && x.MCODE != "" && x.MCODE != undefined), IndentReceivedFromOutlet: IndentReceivedFromOutlet };
    this.http

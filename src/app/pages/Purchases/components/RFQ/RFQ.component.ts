...
// import { DropdownSettings } from 'angular4-multiselect-dropdown'


// @Component({
//     selector: "trnmain-rfq-entry",
//     styleUrls: ["../../../Style.css"],
...
//     public selectedSuppliers: TAcList[] = [];
//     CashList: TAcList[] = [];
//     BankList: TAcList[] = [];
//     AppSettings;
//     RETTO: string;
...
//     supplierDropdownSettings: DropdownSettings = {
...
//         },
//             error => {
//                 this.masterService.resolveError(error, 'trnmain-RFQ-getSupplierList');
//             }, () => {
...
//         }
//     }
//     onSupplierMultiSelect(item) {
//         
//         let detailsArray = this.TrnMainForm.controls.SuppliersArray as FormArray;
//         this.clearFormArray(detailsArray);
//         let builder = this._fb;
//         this.selectedSuppliers.forEach(function (item) {
//             detailsArray.push(
//                 builder.group({
//                     ACID: item.ACID,
//                     ACNAME: item.ACNAME

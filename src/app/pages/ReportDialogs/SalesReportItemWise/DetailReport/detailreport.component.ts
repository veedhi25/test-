...
@Component({
    selector : 'result-sdetailreport-dialog',
    templateUrl : './detailreport.component.html',
    styleUrls: ["../../../Reports/reportStyle.css","../../../modal-style.css"]

})

export class SDetailReport{
    ReportParameters:any=<any>{};
    division: any[]=[];  
    
   
    @Output() reportdataEmit = new EventEmitter();
    constructor(private masterService: MasterRepo,public dialogref:MdDialogRef<SDetailReport>, @Inject(MD_DIALOG_DATA) public data: DialogInfo){
    ...
    public DialogClosedResult(res) {
        ...
        this.reportdataEmit.emit({ status: res, data: {reportname:'SalesReport-ItemWise-Detail', reportparam:this.ReportParameters}});

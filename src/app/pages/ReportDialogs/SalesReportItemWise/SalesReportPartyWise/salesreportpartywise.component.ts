...
@Component({
    selector: 'result-salesreportpartywise-dialog',
    templateUrl: './salesreportpartywise.component.html',
    styleUrls: ["../../../Reports/reportStyle.css", "../../../modal-style.css"]

})

export class SalesReportPartyWise {
    ReportParameters: any = <any>{};
    division: any[] = [];
    customerList: any[] = [];

    @Output() reportdataEmit = new EventEmitter();
    constructor(private masterService: MasterRepo, public dialogref: MdDialogRef<SalesReportPartyWise>, @Inject(MD_DIALOG_DATA) public data: DialogInfo) {
        ...
        this.ReportParameters.TOPNSORT = "0";
        this.ReportParameters.CheckSummaryReport = "1";
        this.ReportParameters.OPT_RMODE = "0";
        this.ReportParameters.OPT_SuppilerWise = "0";
        this.ReportParameters.CUSTOMER_ACID  = "%";
        ...
        this.masterService.getCustomers()
            .subscribe(res => {
                //console.log("customerList"+ JSON.stringify(res));
                //this.customerList.push(JSON.stringify(res));
    ...
    public DialogClosedResult(res) {
        ...
        this.ReportParameters.CUSTOMER_ACID = (this.ReportParameters.CUSTOMER_ACID == null || this.ReportParameters.CUSTOMER_ACID == "") ? "%" : this.ReportParameters.CUSTOMER_ACID;

        this.reportdataEmit.emit({ status: res, data: { reportname: 'SalesFigureAnalysis', reportparam: this.ReportParameters } });

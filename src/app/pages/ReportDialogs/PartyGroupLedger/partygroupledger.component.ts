...
@Component({
    selector : 'result-partygroupledger-dialog',
    templateUrl : './partygroupledger.component.html',
    styleUrls: ["../../Reports/reportStyle.css","../../modal-style.css"]


})

export class PartyGroupLedger{
 ReportParameters:any=<any>{};
 division: any[]=[];   
 
    @Output() reportdataEmit = new EventEmitter();
    constructor(private masterService: MasterRepo,public dialogref:MdDialogRef<PartyGroupLedger>, @Inject(MD_DIALOG_DATA) public data: DialogInfo){
   ...
   public DialogClosedResult(res) {
    ...
    this.reportdataEmit.emit({ status: res, data: {reportname:'Party Group Ledger', reportparam:this.ReportParameters}});

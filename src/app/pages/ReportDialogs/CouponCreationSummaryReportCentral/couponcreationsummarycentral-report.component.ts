...
@Component({
  selector: 'couponcreationsummaryreportcentral',
  templateUrl: './couponcreationsummarycentral-report.component.html',
  styleUrls: ["../../modal-style.css", "../../Reports/reportStyle.css"],

})

export class CouponCreationSummaryReportCentral {

...
@Component({
    selector : 'result-bankstatementreport-dialog',
    templateUrl : './bankstatementreport.component.html',
    styleUrls: ["../../../Reports/reportStyle.css","../../../modal-style.css"]
})

export class BankStatementReport{
 ...
 fullAcList : any[]=[]; 
    ...
    constructor(private masterService: MasterRepo,public dialogref:MdDialogRef<BankStatementReport>, @Inject(MD_DIALOG_DATA) public data: DialogInfo){
   ...
   public DialogClosedResult(res) {
    ...
    //alert(this.ReportParameters.DIVISION + "!!" + this.ReportParameters.ACID);
    this.reportdataEmit.emit({ status: res, data: {reportname:'Bank_Statement', reportparam:this.ReportParameters}});

...
export class DebtorsReport{
    ...
    constructor(private masterService: MasterRepo,public dialogref:MdDialogRef<DebtorsReport>, @Inject(MD_DIALOG_DATA) public data: DialogInfo){
...
this.masterService.getAllDivisions()
  .subscribe(res => {
    ...
    public DialogClosedResult(res) {
        ...
        // this.ReportParameters.DATE1;
        // this.ReportParameters.DATE2;
        // this.ReportParameters.D1;
        // this.ReportParameters.D2;
        // this.ReportParameters.D3;
        // this.ReportParameters.D4;
        // this.ReportParameters.DIVISION;
        // this.ReportParameters.OPT_EXNEGETIVE;
        // this.ReportParameters.CHK_OPNINGONLY;
        // this.ReportParameters.CHK_STATUS;
        // this.ReportParameters.CHK_SHOWDETAIL;

        console.log("this Reportparam"+JSON.stringify(this.ReportParameters));

       // this.reportdataEmit.emit({ status: res, data: {reportname:'Debtors Report', reportparam:this.ReportParameters}});

        this.reportdataEmit.emit({ status: res, data: {reportname:'Debtors Report', reportparam:{
            ...
            CHK_AGEINGOFPARTYOPENING: this.ReportParameters.CHK_SHOWAGEINGREPORT,

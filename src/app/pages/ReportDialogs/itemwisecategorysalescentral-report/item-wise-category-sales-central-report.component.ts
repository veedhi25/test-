...
@Component({
  selector: 'item-wise-category-sales-central-report',
  templateUrl: './item-wise-category-sales-central-report.component.html',
  styleUrls: ["../../modal-style.css", "../../Reports/reportStyle.css"],

})
export class ItemWiseCategorySalesCentralReport {

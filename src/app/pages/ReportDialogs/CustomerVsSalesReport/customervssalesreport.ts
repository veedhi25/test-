...
@Component({
    selector : 'result-customervssalesreport-dialog',
    templateUrl : './customervssalesreport.component.html',
    styleUrls: ["../../Reports/reportStyle.css","../../modal-style.css"]

})

export class CustomerVsSalesReport{
    ...
    constructor(private masterService: MasterRepo,public dialogref:MdDialogRef<CustomerVsSalesReport>, @Inject(MD_DIALOG_DATA) public data: DialogInfo){
    ...
    public DialogClosedResult(res) {
        ...
        this.ReportParameters.MENUCAT = "%";
        this.ReportParameters.ACID = "%";

        this.reportdataEmit.emit({ status: res, data: {reportname:'Customers Vs Sales Report', reportparam:this.ReportParameters}});

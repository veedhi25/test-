...
@Component({
    selector : 'result-debitnote-dialog',
...
export class DebitNote{
    ...
    constructor(private masterService: MasterRepo,public dialogref:MdDialogRef<DebitNote>, @Inject(MD_DIALOG_DATA) public data: DialogInfo){
    ...
    public DialogClosedResult(res) {
        ...
        this.ReportParameters.PHISCALID = "75/76";
        ...
        this.reportdataEmit.emit({ status: res, data: {reportname:'Debit Note Register Report', reportparam:this.ReportParameters}});

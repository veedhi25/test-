...
@Component({
  selector: 'coupondiscountreceivedreportcentral',
  templateUrl: './coupondiscountreceivedcentral-report.component.html',
  styleUrls: ["../../modal-style.css", "../../Reports/reportStyle.css"],

})

export class CouponDiscountReceivedReportCentral {

...
@Component({
    selector: 'customerwisedetailloyaltycentral-report',
    templateUrl: './customerwisedetailloyaltycentral-report.component.html',
    styleUrls: ["../../modal-style.css", "../../Reports/reportStyle.css"],


})
export class CustomerWiseDetailLoyaltyCentralReport {

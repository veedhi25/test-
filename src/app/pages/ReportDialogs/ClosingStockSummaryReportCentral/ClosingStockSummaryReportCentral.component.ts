...
@Component({
  selector: 'ClosingStockSummaryReportCentral',
  templateUrl: './ClosingStockSummaryReportCentral.component.html',
  styleUrls: ["../../modal-style.css", "../../Reports/reportStyle.css"],

})
export class ClosingStockSummaryReportCentral implements OnInit {

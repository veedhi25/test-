...
@Component({
  selector: 'ClosingStockSummaryReport',
  templateUrl: './ClosingStockSummaryReport.component.html',
  styleUrls: ["../../modal-style.css", "../../Reports/reportStyle.css"],

})
export class ClosingStockSummaryReport implements OnInit {
  ...
  ngOnInit() {
    this.wareHouseList=[];
    this.masterService.getWarehouseList().subscribe(a => {
   
      this.wareHouseList.push(a);

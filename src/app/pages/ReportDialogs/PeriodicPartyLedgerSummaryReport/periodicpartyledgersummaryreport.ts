...
@Component({
    selector : 'result-periodicpartyledgersummaryreport-dialog',
    templateUrl : './periodicpartyledgersummaryreport.component.html',
    styleUrls: ["../../Reports/reportStyle.css","../../modal-style.css"]

})

export class PeriodicPartyLedgerSummaryReport{
    ReportParameters:any=<any>{};   
    division : any[]=[];
   
    @Output() reportdataEmit = new EventEmitter();
    constructor(private masterService: MasterRepo,public dialogref:MdDialogRef<PeriodicPartyLedgerSummaryReport>, @Inject(MD_DIALOG_DATA) public data: DialogInfo){
    ...
    public DialogClosedResult(res) {
        ...
        this.reportdataEmit.emit({ status: res, data: {reportname:'Periodic Party Ledger Summary Report', reportparam:this.ReportParameters}});

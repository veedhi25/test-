...
@Component({
    selector: 'result-purchasereportsupplierwise-dialog',
    templateUrl: './purchasereportsupplierwise.component.html',
    styleUrls: ["../../../Reports/reportStyle.css", "../../../modal-style.css"]

})

export class PurchaseReportSupplierWise {
    ...
    constructor(private masterService: MasterRepo, public dialogref: MdDialogRef<PurchaseReportSupplierWise>, @Inject(MD_DIALOG_DATA) public data: DialogInfo) {
        ...
        this.ReportParameters.AMOUNT = "0";
        this.ReportParameters.SUMMARY = "0";
    ...
    public DialogClosedResult(res) {
        ...
        this.reportdataEmit.emit({ status: res, data: { reportname: 'Purchase Figure Supplier Wise', reportparam: this.ReportParameters } });

...
export class PSummaryReport{
    ...
    constructor(private masterService: MasterRepo,public dialogref:MdDialogRef<PSummaryReport>, @Inject(MD_DIALOG_DATA) public data: DialogInfo){
    ...
    public DialogClosedResult(res) {
        ...
        this.reportdataEmit.emit({ status: res, data: {reportname:'Purchase Report-Item Wise', reportparam:this.ReportParameters}});

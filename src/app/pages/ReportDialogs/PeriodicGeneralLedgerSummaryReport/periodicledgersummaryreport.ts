...
@Component({
    selector : 'result-periodicledgersummaryreport-dialog',
    templateUrl : './periodicledgersummaryreport.component.html',
    styleUrls: ["../../Reports/reportStyle.css","../../modal-style.css"]

})

export class PeriodicLedgerSummaryReport{
    ReportParameters:any=<any>{};
    division : any[]=[];
   
    @Output() reportdataEmit = new EventEmitter();
    constructor(private masterService: MasterRepo,public dialogref:MdDialogRef<PeriodicLedgerSummaryReport>, @Inject(MD_DIALOG_DATA) public data: DialogInfo){
    ...
    public DialogClosedResult(res) {
        ...
        this.reportdataEmit.emit({ status: res, data: {reportname:'Periodic Ledger Summary Report', reportparam:this.ReportParameters}});

...
@Component({
  selector: 'PRvsSR-report',
  templateUrl: './PrVsSrReport.html',
  styleUrls: ["../../modal-style.css", "../../Reports/reportStyle.css"],

})
export class PrvsSrReportComponent {
  @Output() reportdataEmit = new EventEmitter();
  constructor(public reportFilterService: ReportMainSerVice, public masterService: MasterRepo) {
    
  }
  onload() {
    this.reportFilterService.repObj.reportname="PR vs SR status report";

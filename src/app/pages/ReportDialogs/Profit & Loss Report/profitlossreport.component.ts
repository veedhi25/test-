...
@Component({
    selector : 'result-profitlossreport-dialog',
...
export class ProfitLossReport{
    ...
    constructor(private masterService: MasterRepo,public dialogref:MdDialogRef<ProfitLossReport>, @Inject(MD_DIALOG_DATA) public data: DialogInfo){
        ...
        this.ReportParameters.CHK_SHOWSUBLEDGER = "0";
    ...
    public DialogClosedResult(res) {
        ...
        //alert("date1"+this.ReportParameters.DATE1 +"-DATE2" + this.ReportParameters.DATE2 +"--div"+ this.ReportParameters.DIVISION + "phist--"+ this.ReportParameters.PHISCALID);
        this.reportdataEmit.emit({ status: res, data: {reportname:'Profit & Loss Report', reportparam:this.ReportParameters}});

...
@Component({
  selector: 'PurchaseSummaryCategoryCentral',
  templateUrl: './PurchaseSummaryCategoryCentralReport.component.html',
  styleUrls: ["../../modal-style.css", "../../Reports/reportStyle.css"],

})
export class PurchaseSummaryCategoryCentralReport {
  modelList: any[] = [];
  modelListinit: any[] = [];
  outletList: any[] = [];

...
@Component({
  selector: 'CurrentStockCategoryWiseSummaryCentralReport',
  templateUrl: './CurrentStockCategoryWiseSummaryCentralReport.component.html',
  styleUrls: ["../../modal-style.css", "../../Reports/reportStyle.css"],

})
export class CurrentStockCategoryWiseSummaryCentralReport {
  modelList: any[] = [];
  modelListinit: any[] = [];
  outletList: any[] = [];

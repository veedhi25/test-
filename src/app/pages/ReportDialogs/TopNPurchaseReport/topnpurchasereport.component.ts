...
import { Division, ProductType } from '../../../common/interfaces';
...
@Component({
    selector: 'result-topnpurchasereport-dialog',
    templateUrl: './topnpurchasereport.component.html',
    styleUrls: ["../../Reports/reportStyle.css", "../../modal-style.css"]

})

export class TopNPurchaseReport {
    ...
    constructor(private masterService: MasterRepo, public dialogref: MdDialogRef<TopNPurchaseReport>, @Inject(MD_DIALOG_DATA) public data: DialogInfo) {
        ...
        this.ReportParameters.OPT_FLAG = "1";
        this.ReportParameters.OPT_REPMODE = "1";
        this.ReportParameters.DIV = "%";
        ...
        this.masterService.getMGroupFromMenuItem()
            .subscribe(res => {
                this.mgroup.push(res);
    ...
    public DialogClosedResult(res) {
        this.ReportParameters.DIV = (this.ReportParameters.DIV == null || this.ReportParameters.DIV == "") ? "%" : this.ReportParameters.DIV;
        this.ReportParameters.VCHR = "X";
        this.ReportParameters.SUPPLIER_ACID = "%";
        this.ReportParameters.MGROUP = (this.ReportParameters.MGROUP == null || this.ReportParameters.MGROUP == "") ? "%" : this.ReportParameters.MGROUP;
        this.reportdataEmit.emit({ status: res, data: { reportname: 'Top N Purchase Report', reportparam: this.ReportParameters } });

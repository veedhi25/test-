...
@Component({
    selector : 'result-salesreturn-dialog',
...
export class SalesReturn{
    ...
    constructor(private masterService: MasterRepo,public dialogref:MdDialogRef<SalesReturn>, @Inject(MD_DIALOG_DATA) public data: DialogInfo){
    ...
    public DialogClosedResult(res) {
        ...
        this.reportdataEmit.emit({ status: res, data: {reportname:'Credit Note Register Report', reportparam:this.ReportParameters}});

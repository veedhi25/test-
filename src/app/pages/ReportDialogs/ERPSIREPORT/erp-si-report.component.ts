...
@Component({
  selector: 'erpsireport',
  templateUrl: './erp-si-report.component.html',
  styleUrls: ["../../modal-style.css", "../../Reports/reportStyle.css"],

})
export class ERPSIREPORTCOMPONENT {
  ...
  OnvendorSelect() {
    this.reportGrid.show("",false,"customer");
  }

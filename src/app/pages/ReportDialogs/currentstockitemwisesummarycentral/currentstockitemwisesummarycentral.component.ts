...
@Component({
  selector: 'currentstockitemwisesummarycentral',
  templateUrl: './currentstockitemwisesummarycentral.component.html',
  styleUrls: ["../../modal-style.css", "../../Reports/reportStyle.css"],

})
export class currentstockitemwisesummarycentral implements OnInit {

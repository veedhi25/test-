...
@Component({
  selector: 'BillWiseItemWiseSalesCentralReport',
  templateUrl: './BillWiseItemWiseSalesCentralReport.component.html',
  styleUrls: ["../../modal-style.css", "../../Reports/reportStyle.css"],

})
export class BillWiseItemWiseSalesCentralReport {
  modelList: any[] = [];
  modelListinit: any[] = [];
  outletList: any[] = [];

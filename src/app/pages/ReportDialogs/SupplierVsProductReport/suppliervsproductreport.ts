...
@Component({
    selector : 'result-suppliervsproductreport-dialog',
    templateUrl : './suppliervsproduct.component.html',
    styleUrls: ["../../Reports/reportStyle.css","../../modal-style.css"]

})

export class SupplierVsProductReport{
    ...
    constructor(private masterService: MasterRepo,public dialogref:MdDialogRef<SupplierVsProductReport>, @Inject(MD_DIALOG_DATA) public data: DialogInfo){
        ...
        this.ReportParameters.CHK_EXCLUDEVAT = "0";
    ...
    public DialogClosedResult(res) {
        ...
        this.reportdataEmit.emit({ status: res, data: {reportname:'Supplier Vs Product Analysis Report', reportparam:this.ReportParameters}});

...
@Component({
    selector: 'purchase-invoice-detail-central-report',
    templateUrl: './purchase-invoice-detail-central.component.html',
    styleUrls: ["../../modal-style.css", "../../Reports/reportStyle.css"],

})
export class PurchaseInvoiceDetailCentralReport {
    modelList: any[] = [];
    modelListinit: any[] = [];
    outletList: any[] = [];

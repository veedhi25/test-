...
@Component({
    selector : 'result-purchasereturnreport-dialog',
...
export class PurchaseReturnReport{
   ...
   supplierList: any[] = [];
       ...
       constructor(private masterService: MasterRepo,public dialogref:MdDialogRef<PurchaseReturnReport>, @Inject(MD_DIALOG_DATA) public data: DialogInfo){
                ...
                this.ReportParameters.FX_VOUCHER_TYPE = "PR";
       ...
       //alert("div"+this.ReportParameters.DIVISION + "--supacid"+ this.ReportParameters.SUPPLIER_ACID);
       this.reportdataEmit.emit({ status: res, data: {reportname:'Purchase Return Book Report', reportparam:this.ReportParameters}});

...
@Component({
  selector: 'customer-bill-reminder-report',
  templateUrl: './customer-bill-reminder-report.component.html',
  styleUrls: ["../../modal-style.css", "../../Reports/reportStyle.css"],

})
export class CustomerBillReminderReport implements OnInit {

...
@Component({
    selector : 'result-topnsalesanalysisreport-dialog',
    templateUrl : './topnsalesanalysisreport.component.html',
    styleUrls: ["../../Reports/reportStyle.css","../../modal-style.css"]

})

export class TopNSalesAnalysisReport{
    ...
    constructor(private masterService: MasterRepo,public dialogref:MdDialogRef<TopNSalesAnalysisReport>, @Inject(MD_DIALOG_DATA) public data: DialogInfo){
    ...
    public DialogClosedResult(res) {
        ...
        this.reportdataEmit.emit({ status: res, data: {reportname:'Top N Sales Analysis Report', reportparam:this.ReportParameters}});

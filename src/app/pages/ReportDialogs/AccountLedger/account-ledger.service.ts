...
export class AccountLedgerService {
    ...
    public getaccountLedgerData(from, to, acid, div) {
        return this.http.get(`${this.apiUrl}/getAccountLedger?DATE1=${from}&DATE2=${to}&ACID=AT01002&DIV=${div}`, this.getRequestOption())

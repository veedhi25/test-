...
@Component({
    selector : 'result-bankreconsillationreport-dialog',
    templateUrl : './bankreconsillationreport.component.html',
    styleUrls: ["../../Reports/reportStyle.css","../../modal-style.css"]

})

export class BankReconsillationReport{
    ReportParameters:any=<any>{};
    division: any[]=[];   
   
    @Output() reportdataEmit = new EventEmitter();
    constructor(private masterService: MasterRepo,public dialogref:MdDialogRef<BankReconsillationReport>, @Inject(MD_DIALOG_DATA) public data: DialogInfo){
    ...
    public DialogClosedResult(res) {
        ...
        this.reportdataEmit.emit({ status: res, data: {reportname:'Bank Reconstillation Report', reportparam:this.ReportParameters}});

...
@Component({
    selector:'result-voucherbook-dialog',
...
export class VoucherBook{
 ...
 @Output() reportdataEmit = new EventEmitter();
    ...
    constructor(private masterService: MasterRepo,public dialogref:MdDialogRef<VoucherBook>, @Inject(MD_DIALOG_DATA) public data: DialogInfo){
        ...
        this.ReportParameters.OPT_VTYPE = "RV";
...
this.DialogClosedResult("ok");
   ...
   public DialogClosedResult(res) {
    ...
    this.reportdataEmit.emit({ status: res, data: {reportname:'Voucher Book', reportparam:this.ReportParameters}});

...
@Component({
  selector: 'StockandSalesItemSummaryCentral',
  templateUrl: './StockandSalesItemSummaryCentral.component.html',
  styleUrls: ["../../modal-style.css", "../../Reports/reportStyle.css"],

})
export class StockandSalesItemSummaryCentral implements OnInit {

...
@Component({
    selector : 'result-overallsupplierperformancereport-dialog',
    templateUrl : './overallsupplierperformancereport.component.html',
    styleUrls: ["../../Reports/reportStyle.css","../../modal-style.css"]

})

export class OverallSupplierperformanceReport{
    ReportParameters:any=<any>{};
    division:any[]=[];  
   
    @Output() reportdataEmit = new EventEmitter();
    constructor(private masterService: MasterRepo,public dialogref:MdDialogRef<OverallSupplierperformanceReport>, @Inject(MD_DIALOG_DATA) public data: DialogInfo){
    ...
    public DialogClosedResult(res) {
        ...
        this.reportdataEmit.emit({ status: res, data: {reportname:'Overall Supplier Performance Report', reportparam:this.ReportParameters}});

...
@Component({
  selector: 'StockandSalesCategorySummary',
  templateUrl: './StockandSalesCategorySummary.component.html',
  styleUrls: ["../../modal-style.css", "../../Reports/reportStyle.css"],

})
export class StockandSalesCategorySummary implements OnInit {
  modelList: any[] = [];
  modelListinit: any[] = [];
  outletList: any[] = [];

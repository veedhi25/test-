...
@Component({
  selector: 'sales-area-list',
  templateUrl: './sales-area-list.component.html',
  styleUrls: ["../../../modal-style.css"],
})
export class SalesAreaTypeListComponent extends AppComponentBase{
  ...
  constructor(
    ...
    public injector : Injector
      ...
      super(injector);
    try { 
      let apiUrl = `${this.apiUrl}/getAllSalesAreaTypePagedList`;
  ...
  addNewSalesAreaType(): void {
    try {
     
        this.router.navigate(["./pages/masters/salesareatype/add-salesareatype", { mode: "add", returnUrl: this.router.url }])
  ...
  onEditClick(event): void {
    try {
    this.router.navigate(["./pages/masters/salesareatype/add-salesareatype", { salesAreaTypeCode: event.data.SalesAreaTypeCode, mode: "edit", returnUrl: this.router.url }]);

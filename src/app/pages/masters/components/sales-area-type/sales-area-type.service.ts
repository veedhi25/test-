...
export class SalesAreaTypeService {
   ...
   private get apiUrl():string{
     ...
     getSalesAreaType(bid:string) {
        let res={status:"error",result:""};
        let returnSubject:Subject<any>=new Subject();
        console.log("about to edit");
        let bodyData = {mode:'query',data:{BID:bid}};
        this.http.post(this.apiUrl +'/getSalesAreaType',bodyData,this.getRequestOption())
            .subscribe(response=>{
    ...
    getParentSalesAreaTypeCode() {
        return this.http.get(this.apiUrl + '/getAllParentSalesAreaTypeCode', this.getRequestOption())

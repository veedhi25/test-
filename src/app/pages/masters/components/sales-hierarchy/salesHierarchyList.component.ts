...
@Component({
  selector: 'sales-hierarchy-list',
  templateUrl: './salesHierarchyList.component.html',
  providers: [MasterRepo],
  styleUrls: ["../../../modal-style.css"],
})
export class SalesHierarchyListComponent extends AppComponentBase{
  ...
  constructor(
    ...
    public injector : Injector
      ...
      super(injector);
    try { 
      let apiUrl = `${this.apiUrl}/getAllSalesHierarchyPagedList`;
  ...
  addNewProductHierarchy(): void {
    try {
     ...
     // if (this._authService.checkMenuRight("BranchList", "add") == true) {
        this.router.navigate(["./pages/masters/salesHierarchy/add-salesHierarchy", { mode: "add", returnUrl: this.router.url }])
     // } else {
  ...
  onEditClick(event): void {
    try {
    this.router.navigate(["./pages/masters/salesHierarchy/add-salesHierarchy", { Id: event.data.Id, mode: "edit", returnUrl: this.router.url }]);

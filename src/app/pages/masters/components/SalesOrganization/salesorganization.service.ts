...
export class salesOrganizationService {
   ...
   private get apiUrl():string{
     ...
     getSalesOrganization(chanelId:string) {
        let res={status:"error",result:""};
        let returnSubject:Subject<any>=new Subject();
        console.log("about to edit");
        let bodyData = {mode:'query',data:{BID:chanelId}};
        this.http.post(this.apiUrl +'/getSalesOrganization',bodyData,this.getRequestOption())
            .subscribe(response=>{

...
export class GeographicalHierarchyService {
   ...
   private get apiUrl():string{
     ...
     getGeographicalHierarchy(bid:string) {
        let res={status:"error",result:""};
        let returnSubject:Subject<any>=new Subject();
        console.log("about to edit");
        let bodyData = {mode:'query',data:{BID:bid}};
        this.http.post(this.apiUrl +'/getGeographicalHierarchy',bodyData,this.getRequestOption())
            .subscribe(response=>{
     ...
     getGeographicalHierarchyParent(Type:string) {
        let res={status:"error",result:""};
        let returnSubject:Subject<any>=new Subject();
        console.log("about to edit");
        let bodyData = {mode:'query',data:{BID:Type}};
        this.http.post(this.apiUrl +'/getGeographicalHierarchyParentList',bodyData,this.getRequestOption())
            .subscribe(response=>{
                let data = response.json();
                if(data.status == 'ok'){
                    returnSubject.next(data);
    ...
    public saveGeographicalHeirarchy(mode: string, warehouse: any) {
        let res = { status: "error", result: "" }
        let returnSubject: Subject<any> = new Subject();
      ...
      //  console.log(opt.headers.toJSON());
        ...
        this.http.post(this.apiUrl + "/saveGeographicalHierarchy", bodyData, this.getRequestOption())
            .subscribe(data => {

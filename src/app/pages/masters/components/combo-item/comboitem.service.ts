...
export class ComboItemService {
    ...
    //saving combo configuration
    saveComboConfig(mode:string, data:any[]) {
        let res = { status: "error", result: "" };
        let returnSubject: Subject<any> = new Subject();
        let bodyData ={
            mode:mode,
            comboconfiglist:data
        };
        this.http.post(this.apiUrl + '/saveComboGroupConfiguration', bodyData,this.getRequestOption())

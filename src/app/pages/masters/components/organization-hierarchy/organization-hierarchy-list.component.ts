...
@Component({
  selector: 'organization-hierarchy-list',
  templateUrl: './organization-hierarchy-list.component.html',
  providers: [MasterRepo],
  styleUrls: ["../../../modal-style.css"],
})
export class OrganizationHierarchyListComponent extends AppComponentBase{
  ...
  constructor(
    ...
    public injector : Injector
      ...
      super(injector);
    try { 
      let apiUrl = `${this.apiUrl}/getAllOrganizationHierarchyPagedList`;
  ...
  addNewOrganizationHierarchy(): void {
    try {
     
        this.router.navigate(["./pages/masters/organizationhierarchy/add-organizationhierarchy", { mode: "add", returnUrl: this.router.url }])
  ...
  onEditClick(event): void {
    try {
    this.router.navigate(["./pages/masters/organizationhierarchy/add-organizationhierarchy", { orgCode: event.data.OrgCode, mode: "edit", returnUrl: this.router.url }]);
